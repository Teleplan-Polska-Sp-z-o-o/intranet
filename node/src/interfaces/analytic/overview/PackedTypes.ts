...
//   export type TTransactions = RawTransaction[]; //ITransactionsRow[]
//   export type TTransactionsPackingRow = RawTransaction & {
//     //ITransactionsRow
//     hour: number;
//     shift: 1 | 2 | 3;
...
//   export interface IBaseModelsObj {
//     [key: string]: any;
//     GROUP_NAME: string;
//     GROUP_LETTER: string;
//     IFS_PART_NO: string;
...
//   export type IBaseModelsObjs = IBaseModelsObj[];

//   export interface IPlansObj {
//     [key: string]: any;
//     LINE: string; // "linia"
//     DATE: Date; // "data"
//     SHIFT: 1 | 2 | 3; // "zmiana"
...
//   export type IPlansObjs = IPlansObj[];
