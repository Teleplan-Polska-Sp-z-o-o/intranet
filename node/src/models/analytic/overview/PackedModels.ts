...
// import { PackedTypes } from "../../../interfaces/analytic/overview/PackingTypes";

// export namespace PackingModels {
...
//       const hour: number = now.hour(); // Get current hour in Warsaw timezone
//       const todaysDateStr: string = now.format("YYYY-MM-DD");
...
//       modelsObjs: PackedTypes.IBaseModelsObjs,
//       plansObjs: PackedTypes.IPlansObjs
//     ) {
...
//       this.buildModelsCache(modelsObjs);
//       this.buildPlansCache(plansObjs, transactionDatesSet);
//       this.buildPackedRows(transactions, transactionDatesSet);
//       this.addSummaryRows();
//     }

//     private buildModelsCache(modelsObj: PackedTypes.IBaseModelsObjs) {
...
//     private buildPlansCache(plansObj: PackedTypes.IPlansObjs, transactionDatesSet: Set<string>) {
//       plansObj.forEach((plan) => {
//         // const planDate: string = new Date(plan.DATE).toISOString().split("T")[0];
//         const planDate: string = moment.tz(plan.DATE, "Europe/Warsaw").format("YYYY-MM-DD");
...
//         const dateStr = moment.tz(transaction.datedtz, "Europe/Warsaw").format("YYYY-MM-DD");
//         const hour = moment.tz(transaction.datedtz, "Europe/Warsaw").hour();
