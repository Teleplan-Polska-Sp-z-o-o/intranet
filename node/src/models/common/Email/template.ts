...
>
  <head>
    ...
    <title>New email template 2024-05-02</title>
    <!--[if (mso 16)]>
      <style type="text/css">
        a {
                              ...
                              >
                                <tr>
                                  <td align="center" style="padding: 0; margin: 0; font-size: 0px">
                                    <img
                                      class="adapt-img"
                                      src="https://eiolvhr.stripocdn.email/content/guids/CABINET_78696501a77c95f4f8466ef5e3878b0f1d5341c9f0240aa8f777aacc52415b9f/images/reconextlogo.png"
                                      alt
                                      style="
                                        display: block;
                                        border: 0;
                                ...
                                <tr>
                                  <td align="center" style="padding: 0; margin: 0">
                                    <span
                                      ...
                                      "
                                      ><a
                                        href="${configuration.button1Href}"
                                        class="es-button"
                                        target="_blank"
                                        style="
                                          mso-style-priority: 100 !important;
                                          ...
                                          text-align: center;
                                          mso-padding-alt: 0;
                                          mso-border-alt: 10px solid #345ca8;
                                        "
                                      >
                                        ${configuration.button1Text}
                                      </a></span
                                    >
                                  </td>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  >
                                    <p
                                      ...
                                      "
                                    >
                                      ${configuration.underButtonsText}
                                    </p>
                                  </td>
                                </tr>
                                <tr>
