...
import { Lenovo, TouchTimeUnit } from "../../Models/models/TouchTime";
import { NRecords } from "../../Models/RecordTypes";
import { Hour, Quarter, TimePeriodMetrics, TimeUnit } from "../../Models/time/TimeModels";

export class LenovoEfficiencyBuilder<T extends Lenovo.TTS> {
  ...
  constructor(
    ...
    this.models = new Models(modelsMatrix, (model: T) => model["IFS_PART_NO"], touchTimeKey);
