...
export namespace EfficiencyTypes {
  ...
  export type PackModelObj = BaseModelObj & TTPack;
  export type CosmModelObj = BaseModelObj & TTCosm;
  export type OobaModelObj = BaseModelObj & TTOoba;

  export type IModelObj = PackModelObj | CosmModelObj | OobaModelObj;
  ...
  class TimePeriodMetrics implements ITimePeriodMetrics {
    efficiency: number;
    processing_time: number;
    processed_units: number;
  ...
  export interface IProcessedEmployee {
    ...
    quarterlyChart: Record<string, TimePeriodMetrics>;
  }

  export type IProcessedEmployees = IProcessedEmployee[];

  export class EfficiencyBuilder<T extends PackModelObj | CosmModelObj | OobaModelObj> {
