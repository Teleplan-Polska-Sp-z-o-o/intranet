const uaC = {
  common: {
    ...
    status_message: {
      ...
      filters_applied: "Фільтри були застосовані.",

      draft_duplicate_name: "Чернетка з таким іменем вже існує. Виберіть іншу назву.",
      draft_duplicate_uuid:
        "Сталася помилка через повторне використання тієї ж інстанції stepper'а. Перезавантажте сторінку та спробуйте ще раз.", //  Ваша робота не буде втрачена.
      draft_consumed_hold:
        "Ваш збережений прогрес було відновлено після оновлення сторінки. Тепер ви можете продовжити роботу над документом.",
      template_not_found: "Назву шаблону документа не знайдено",
    },
    component: {
      file_form: {
