      ...
      createNew: {
        ...
        drafts: {
          ...
          download: {
            ...
            selectFilesHint: "Оберіть один або декілька файлів, пов’язаних із цим документом.",
          },
          draftStatus: {
          ...
          newBasedOnRecordTooltip: "Створити новий чернетковий документ на основі цього запису.",
          downloadGeneratedDocumentsTooltip: "Завантажити згенеровані документи для цієї чернетки.",
