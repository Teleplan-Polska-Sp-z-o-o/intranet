        ...
        dcr: {
          ...
          review: {
            ...
            variant: {
              ...
              check: "перевірити",
              reject: "відхилити",
              question: "Ви впевнені, що хочете ${variant} цей запит на зміну документа?",
            },
            alert: {
              reviewControlsAppearOnComplete:
                "Елементи керування переглядом з'являться, коли запит на зміну документа буде 'Завершено'.",
              reviewGranted: "Перегляд цього запиту на зміну документа було надано.",
              reviewControlsAppearOnChecked:
                "Елементи керування переглядом з'являться після перевірки.",
            },
          ...
          register: {
            ...
            unregister: "Відреєструвати",
            question: "Ви впевнені, що хочете змінити статус реєстрації?",
          },
          stepper: {
            actions: {
              prev: "Попередній",
            ...
            info: {
              reference_info_title: "Що таке Референція?",
              reference_info_text:
                "Референція це унікальний ідентифікатор, який використовується для розрізнення записів документів. Вона з'єднує запит на зміну документа з уже зареєстрованим документом, допомагаючи в реєстрації нової версії. Значення референції можна знайти в інструменті матриці на вкладці документа в записі документа, який потрібно оновити. Для нових документів, які ніколи раніше не були зареєстровані, можна вибрати 'Створити нову референцію'. Після створення нову референцію можна вставити із запиту у форму реєстрації або використати для оновлення існуючої референції документа в матриці, зв'язуючи її із запитом.",
            ...
            vStepperWindowItem: {
              ...
              "5": {
                ...
                requireAcknowledgmentOrTraining: "Потребує Підтвердження або Навчання",
